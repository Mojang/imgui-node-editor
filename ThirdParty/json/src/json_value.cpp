...
#pragma warning (suppress : 4463) // overflow; assigning 1 to bit - field that can only hold values from - 1 to 0
         allocated_ = true;
      }
      else
         value_.string_ = 0;
...
{
	(void)comment;   // silences unused parameter warning
	(void)placement;
}
...
{
	(void)placement;   // silences unused parameter warning
	return false;
}
